...
BootstrapRun.{
  ...
  BuildOnly.{
    ...
    | Horizon.{<horizon-definition.datom> <cluster> <node> <CompleteHost-or-BaseHost> <NoSecrets-or-SecretsDirectory.{<directory>}> <immutable-github-flake-ref> <nix-system> <output-selector>}
